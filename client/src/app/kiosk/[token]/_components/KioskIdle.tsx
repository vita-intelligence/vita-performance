...
export default function KioskIdle({ token, workstationName, workers, onStart }: KioskIdleProps) {
    ...
    if (step === "workers") {
        return (
            <div className="flex flex-col h-full">
                ...
                {/* Checked in bar */}
                {checkedIn.length > 0 && (
                    <div className="px-6 py-3 bg-success/10 border-b border-success/30 flex items-center gap-3 flex-wrap">
                    ...
                    {workers.map((worker) => {
                        ...
                        return (
                            <Button
                                ...
                                variant="bordered"
                                className={`w-full justify-start px-6 h-16 text-lg font-black uppercase tracking-wide rounded-none border transition-colors ${isCheckedIn
