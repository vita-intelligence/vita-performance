...
interface WorkerSessionDetailsDrawerProps {
    session: WorkerStatsSession | null;
    onClose: () => void;
}
...
export default function WorkerSessionDetailsDrawer({ session, onClose }: WorkerSessionDetailsDrawerProps) {
