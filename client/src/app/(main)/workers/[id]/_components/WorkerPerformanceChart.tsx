...
import { WorkerStatsChartPoint } from "@/types/worker";
import {
    ResponsiveContainer,
    LineChart,
    Line,
...
export default function WorkerPerformanceChart({ chart, grouping }: WorkerPerformanceChartProps) {
    ...
    const formatLabel = (key: string) => {
        ...
        if (grouping === 'day') {
            return formatDate(key, settings);
        }
        if (grouping === 'week') {
