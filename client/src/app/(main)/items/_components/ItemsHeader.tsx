...
export default function ItemsHeader({ onAdd }: ItemsHeaderProps) {
    ...
    return (
        <div ref={ref} className="flex items-center justify-between gap-4">
            <div className="flex flex-col gap-1">
                <h1 className="text-3xl font-black text-text">Items</h1>
                <p className="text-muted text-sm hidden sm:block">Manage your products.</p>
            </div>
            <Button
                onPress={onAdd}
